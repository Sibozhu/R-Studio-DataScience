...
NJplot <- qmplot(place_lon, place_lat, data = nj, colour = I('purple'), size = I(3), 
       mapcolor = "bw", main="NJ")
NYplot <- qmplot(place_lon, place_lat, data = ny, colour = I('green'), size = I(3),
       mapcolor = "bw", main="NY")
CAplot <- qmplot(place_lon, place_lat, data = ca, colour = I('blue'), size = I(3), 
       mapcolor = "bw",main="CA")
