...
NM_size_TTL <- within(NM_size_1,rm(TTL_US,N_ENG,MID_ATL_NE))
NM_type_TTL <- within(NM_type_1,rm(TTL_US,N_ENG,MID_ATL_NE))
...
NM_size_TTL[, 2:5]    <- sapply(NM_size_TTL[, 2:5], as.numeric)
NM_type_TTL[, 2:5]    <- sapply(NM_type_TTL[, 2:5], as.numeric)
