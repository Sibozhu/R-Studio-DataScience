...
# Insights: From the histogram of "Trip Distance", we can see that more than 15 thousands people (almost 90% of the total number) choose to take taxi to travel within 5 miles. Since among 20000 total people are being surveyed in this record, taxi company might find this histogram useful in deciding their seasonal strategy of short-distance traveling package. 
...
trip_distance_in_mins <- dbGetQuery(con, statement = "
